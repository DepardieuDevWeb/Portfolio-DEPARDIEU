...
<html lang="en" data-theme="dark">
    <head>
        ...
        <meta name="description" content="@yield('meta_description', "Portfolio
        de Pascal Depardieu developpeur full-stack spécialisé en Laravel et
        Next.js")" />
        <meta
            name="keywords"
            content="Developpement web, Laravel, React, Next.js, JavaScript"
        />
        <meta name="author" content="Pascal Depardieu" />
        <title>
            @yield('meta_title', 'Pascal Depardieu - Développeur Full-stack')
        </title>
        @vite(['resources/css/app.css', 'resources/js/app.js'])
    </head>
    <body>
        <header class="header fade-in-up" id="header">
                ...
                <div class="nav__btns">
                    <div class="nav__menu" id="nav-menu">
                        <div style="margin-top: 4px">
                            <a
                                href="http://www.github.com/DepardieuDev"
                                target="_blank"
                                ><svg
                                    role="img"
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="icon-lang gitHub"
                                >
                                    <title>GitHub</title>
                                    <path
                                        fill="currentColor"
                    ...
                    <svg
                        class="icon-lang theme sun change-theme"
                        id="theme-toggle"
                        viewBox="0 0 24 24"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <main class="container main">@yield('content')</main>
        <footer class="footer scroll-animate">
            &copy; Copyright 2025 Pascal Depardieu
        </footer>
    </body>
</html>
